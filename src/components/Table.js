...
const columns = [
  ...
  },
  {
    dataField: 'button',
    text: (
      <button className="our-products__btn btn-orange" type="submit">
        Вся продукция
      </button>
    ),
  },
...
const products = [
  {
    ...
    article: '2450317',
    image: <img src="./assets/images/products/plates.jpg" />,
  ...
  },
  {
    ...
    title: 'Автопавильон',
    article: '2450317',
    image: <img src="./assets/images/products/avtopavilion.jpg" />,
    description: 'Плиты перекрытия железобетонные многопустотные 1ПК 18-10-10а производятся согласно ГОСТ 9561-91 из тяжелого бетона классом В25 (М200), В35 (М300), легкого бетона плотной структуры и силикатного бетона с использованием предварительно напряженной',
    price: '500',
    length: '990',
    weight: '0.515',
